...
(function ($) {
    $.fn.scannerDetection = function (options) {
        ...
        this.each(function () {
            var self = this; var $self = $(self); var firstCharTime = 0; var lastCharTime = 0; var stringWriting = ''; var callIsScanner = false; var testTimer = false; var scanButtonCounter = 0
